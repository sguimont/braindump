...
<html>
	...
	<body>
		...
		<g:render template="/templates/commentList" model="[controller:'todo', id:todo.id, comments:todo.comments]" />
		<g:render template="/templates/commentAddForm" model="[id:todo.id]" />
	</body>
</html>